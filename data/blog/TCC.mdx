...
In Brazil (where i'm live), when you are in the last year of college or technical courses (1+year), to graduate you need to make the TCC (Trabalho de Conclusão de Curso) what is like the Final Course Project in the college, that will englobe everything you had learned untill now, in the Computer Science courses correlateds like mine (Systems Development) in the most of cases you need to make a end-to-end Software, you'll have to apply theoretical knowledge to  solve real-world problems or to conduct a study that adds value to the discipline.
